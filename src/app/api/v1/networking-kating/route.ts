 ...
 *       Mengembalikan semua networking task yang sudah dilakukan oleh user dengan kakak tingkat.
 *     tags:
 *       - Networking Kating
 *     security:
 *       - bearerAuth: []
 ...
 *                           email: { type: string, example: target@email.com }
 *                           fullname: { type: string, example: Target User }
 *                           faculty: { type: string, example: Ilmu Komputer }
 *                       questions:
 *                         type: array
 *                         items:
 *                           type: object
 ...
 *                             answer: { type: string, example: Jawaban pertanyaan }
 *                             question:
 *                               type: object
 *                               properties:
 *                                 id: { type: integer, example: 1 }
 *                                 question: { type: string, example: Apa hobi kamu? }
 ...
 *                 error: { type: string, example: Headers tidak ditemukan }
